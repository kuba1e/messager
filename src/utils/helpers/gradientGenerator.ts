export default function generate(user_id = "0000000") {
  ...
  return "linear-gradient(233deg,#9a2222,#b63a95)";

  const symbolCharCode = user_id[user_id.length - 1].charCodeAt(0).toString();
